...
// import filterCadreOr from '../filtres/paysage/or.png';
// import filterVs from '../filtres/paysage/VS.png';
// import FilterHappyBirthday from '../filtres/paysage/HappyBirthday.png';
// import HappyBirthday2 from '../filtres/paysage/HappyBirthday2.png';
// import Moustaches from '../filtres/paysage/Moustaches.png';
// import CadreMatous from '../cadres/polaroid/MAMA.png';
// import Matous from '../filtres/polaroid/MATOUS.png';
import POLAROIDBASE from '../POLAROIDBASE.png';
...
function Camera() {
  ...
  const [cadresPAYSAGE, setFiltersPAYSAGE] = useState<string[]>([]);
  const [filtresPOLAROID, setFiltresPOLAROID] = useState<string[]>([]);
  const [cadresPOLAROID, setCadresPOLAROID] = useState<string[]>([]);
  const [cadresMINIPOLAROID, setFiltersMINIPOLAROID] = useState<string[]>([]);
  ...
  const startCamera = async () => {
    ...
    console.log(config)
    const paysageFilters = [];
    config.filtres.paysage.map((filter: { name: string, url: string }) => {
      paysageFilters.push(filter.url);
    })

    setFiltersPAYSAGE(["Aucun filtre"]);
    setFiltresPOLAROID(["Aucun filtre"]);
    setFiltersMINIPOLAROID(["Aucun filtre"]);
    setCadresPOLAROID(["Aucun cadre"]);
